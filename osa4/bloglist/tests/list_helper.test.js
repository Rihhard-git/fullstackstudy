...
describe('total likes',() => {
    ...
    const blogs = [
        ...
        test('of embty list is zero', () => {

            console.log('embty list', listHelper.totalLikes(embtyList))

            assert.strictEqual(listHelper.totalLikes(embtyList), 0)
...
describe('favorite Blog', () => {
    ...
    test('of a bigger list is calculetd right', () => {
